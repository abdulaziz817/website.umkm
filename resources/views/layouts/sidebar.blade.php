  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          <a href="/"><img src="{{ asset('assets/compiled/svg/logo.png') }}" alt="Logo" style="width: 150px; height: auto;" /></a>
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        <li @class(['sidebar-item', 'active' => !Request::segment(1)])>
        ...
        <li @class(['sidebar-item', 'active' => Request::routeIs('barang*')])>
        ...
        <li @class(['sidebar-item', 'active' => Request::routeIs('bagian*')])>
          <a class="sidebar-link" href="/bagian">
            <i class="bi bi-intersect"></i>
            <span>Bagian</span>
          </a>
        </li>

        <li @class(['sidebar-item', 'active' => Request::routeIs('kategori*')])>
        ...
        <li @class(['sidebar-item', 'active' => Request::routeIs('petugas*')])>
...
{{--
        <li @class(['sidebar-item', 'active' => Request::routeIs('pengeluaran*')])>
